...
{
    public partial class AfisareClientiForm : Form
    {
        ...
        private async void Actualizare()
        {
            ...
            Task<DataGridView> dataGridViewUpdateTask = new Task<DataGridView>(() => dbHandler.ActualizareClienti());
