...
{
    public partial class AdaugSoldContForm : Form
    {
        ...
        public AdaugSoldContForm(int id)
        {
            InitializeComponent();
            Actualizare();
        ...
        private async void btnAdaugaSuma_Click(object sender, EventArgs e)
        {
            ...
            {
                if (txtBoxCont.TextLength == 0 || txtBoxCont.TextLength == 0)
                {
                ...
                else
                {
                    ...
                    //Apelare functie de adaugare sold
                }
